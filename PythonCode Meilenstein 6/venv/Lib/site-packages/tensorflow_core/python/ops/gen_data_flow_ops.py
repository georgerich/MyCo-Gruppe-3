...
def resource_accumulator_apply_gradient(handle, local_step, gradient, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ResourceAccumulatorApplyGradient", name,
        _ctx._post_execution_callbacks, handle, local_step, gradient)
      return _result
    except _core._FallbackException:
      try:
...
def ResourceAccumulatorApplyGradient(handle, local_step, gradient, name=None):
  return resource_accumulator_apply_gradient(handle=handle, local_step=local_step, gradient=gradient, name=name)
ResourceAccumulatorApplyGradient.__doc__ = resource_accumulator_apply_gradient.__doc__
ResourceAccumulatorApplyGradient = _doc_controls.do_not_generate_docs(_kwarg_only(ResourceAccumulatorApplyGradient))
tf_export("raw_ops.ResourceAccumulatorApplyGradient")(ResourceAccumulatorApplyGradient)


def resource_accumulator_apply_gradient_eager_fallback(handle, local_step, gradient, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function resource_accumulator_apply_gradient
  """
  _ctx = ctx if ctx else _context.context()
  _attr_dtype, (gradient,) = _execute.args_to_matching_eager([gradient], _ctx)
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
...
def resource_accumulator_num_accumulated(handle, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ResourceAccumulatorNumAccumulated", name,
  ...
  _attrs = None
  _execute.record_gradient(
      "ResourceAccumulatorNumAccumulated", _inputs_flat, _attrs, _result, name)
  _result, = _result
  return _result

def ResourceAccumulatorNumAccumulated(handle, name=None):
  return resource_accumulator_num_accumulated(handle=handle, name=name)
ResourceAccumulatorNumAccumulated.__doc__ = resource_accumulator_num_accumulated.__doc__
ResourceAccumulatorNumAccumulated = _doc_controls.do_not_generate_docs(_kwarg_only(ResourceAccumulatorNumAccumulated))
tf_export("raw_ops.ResourceAccumulatorNumAccumulated")(ResourceAccumulatorNumAccumulated)


def resource_accumulator_num_accumulated_eager_fallback(handle, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function resource_accumulator_num_accumulated
  """
  _ctx = ctx if ctx else _context.context()
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
  _inputs_flat = [handle]
...
def resource_accumulator_set_global_step(handle, new_global_step, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ResourceAccumulatorSetGlobalStep", name,
        _ctx._post_execution_callbacks, handle, new_global_step)
      return _result
    except _core._FallbackException:
      try:
...
def ResourceAccumulatorSetGlobalStep(handle, new_global_step, name=None):
  return resource_accumulator_set_global_step(handle=handle, new_global_step=new_global_step, name=name)
ResourceAccumulatorSetGlobalStep.__doc__ = resource_accumulator_set_global_step.__doc__
ResourceAccumulatorSetGlobalStep = _doc_controls.do_not_generate_docs(_kwarg_only(ResourceAccumulatorSetGlobalStep))
tf_export("raw_ops.ResourceAccumulatorSetGlobalStep")(ResourceAccumulatorSetGlobalStep)


def resource_accumulator_set_global_step_eager_fallback(handle, new_global_step, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function resource_accumulator_set_global_step
  """
  _ctx = ctx if ctx else _context.context()
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
...
def resource_accumulator_take_gradient(handle, num_required, dtype, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ResourceAccumulatorTakeGradient", name,
        _ctx._post_execution_callbacks, handle, num_required, "dtype", dtype)
      return _result
    except _core._FallbackException:
      try:
  ...
  _attrs = ("dtype", _op._get_attr_type("dtype"))
  _execute.record_gradient(
      "ResourceAccumulatorTakeGradient", _inputs_flat, _attrs, _result, name)
  _result, = _result
  return _result

def ResourceAccumulatorTakeGradient(handle, num_required, dtype, name=None):
  return resource_accumulator_take_gradient(handle=handle, num_required=num_required, dtype=dtype, name=name)
ResourceAccumulatorTakeGradient.__doc__ = resource_accumulator_take_gradient.__doc__
ResourceAccumulatorTakeGradient = _doc_controls.do_not_generate_docs(_kwarg_only(ResourceAccumulatorTakeGradient))
tf_export("raw_ops.ResourceAccumulatorTakeGradient")(ResourceAccumulatorTakeGradient)


def resource_accumulator_take_gradient_eager_fallback(handle, num_required, dtype, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function resource_accumulator_take_gradient
  """
  _ctx = ctx if ctx else _context.context()
  dtype = _execute.make_type(dtype, "dtype")
  handle = _ops.convert_to_tensor(handle, _dtypes.resource)
...
def resource_conditional_accumulator(dtype, shape, container="", shared_name="", reduction_type="MEAN", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ResourceConditionalAccumulator", name,
        _ctx._post_execution_callbacks, "dtype", dtype, "shape", shape,
        "container", container, "shared_name", shared_name, "reduction_type",
        reduction_type)
      return _result
    except _core._FallbackException:
      try:
  ...
  _attrs = ("dtype", _op._get_attr_type("dtype"), "shape",
            ...
            _op.get_attr("reduction_type"))
  _execute.record_gradient(
      "ResourceConditionalAccumulator", _inputs_flat, _attrs, _result, name)
  _result, = _result
  return _result

def ResourceConditionalAccumulator(dtype, shape, container="", shared_name="", reduction_type="MEAN", name=None):
  return resource_conditional_accumulator(dtype=dtype, shape=shape, container=container, shared_name=shared_name, reduction_type=reduction_type, name=name)
ResourceConditionalAccumulator.__doc__ = resource_conditional_accumulator.__doc__
ResourceConditionalAccumulator = _doc_controls.do_not_generate_docs(_kwarg_only(ResourceConditionalAccumulator))
tf_export("raw_ops.ResourceConditionalAccumulator")(ResourceConditionalAccumulator)


def resource_conditional_accumulator_eager_fallback(dtype, shape, container="", shared_name="", reduction_type="MEAN", name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function resource_conditional_accumulator
  """
  _ctx = ctx if ctx else _context.context()
  dtype = _execute.make_type(dtype, "dtype")
  shape = _execute.make_shape(shape, "shape")
