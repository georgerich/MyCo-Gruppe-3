...
def AudioSpectrogram(input, window_size, stride, magnitude_squared=False, name=None):
  return audio_spectrogram(input=input, window_size=window_size, stride=stride, magnitude_squared=magnitude_squared, name=name)
AudioSpectrogram.__doc__ = audio_spectrogram.__doc__
AudioSpectrogram = _doc_controls.do_not_generate_docs(_kwarg_only(AudioSpectrogram))
...
def DecodeWav(contents, desired_channels=-1, desired_samples=-1, name=None):
  return decode_wav(contents=contents, desired_channels=desired_channels, desired_samples=desired_samples, name=name)
DecodeWav.__doc__ = decode_wav.__doc__
DecodeWav = _doc_controls.do_not_generate_docs(_kwarg_only(DecodeWav))
...
def EncodeWav(audio, sample_rate, name=None):
  return encode_wav(audio=audio, sample_rate=sample_rate, name=name)
EncodeWav.__doc__ = encode_wav.__doc__
EncodeWav = _doc_controls.do_not_generate_docs(_kwarg_only(EncodeWav))
...
def Mfcc(spectrogram, sample_rate, upper_frequency_limit=4000, lower_frequency_limit=20, filterbank_channel_count=40, dct_coefficient_count=13, name=None):
  return mfcc(spectrogram=spectrogram, sample_rate=sample_rate, upper_frequency_limit=upper_frequency_limit, lower_frequency_limit=lower_frequency_limit, filterbank_channel_count=filterbank_channel_count, dct_coefficient_count=dct_coefficient_count, name=name)
Mfcc.__doc__ = mfcc.__doc__
Mfcc = _doc_controls.do_not_generate_docs(_kwarg_only(Mfcc))
