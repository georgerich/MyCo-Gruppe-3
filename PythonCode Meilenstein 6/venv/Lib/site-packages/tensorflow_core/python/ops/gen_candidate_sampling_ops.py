...
def AllCandidateSampler(true_classes, num_true, num_sampled, unique, seed=0, seed2=0, name=None):
  return all_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, seed=seed, seed2=seed2, name=name)
AllCandidateSampler.__doc__ = all_candidate_sampler.__doc__
AllCandidateSampler = _doc_controls.do_not_generate_docs(_kwarg_only(AllCandidateSampler))
...
def ComputeAccidentalHits(true_classes, sampled_candidates, num_true, seed=0, seed2=0, name=None):
  return compute_accidental_hits(true_classes=true_classes, sampled_candidates=sampled_candidates, num_true=num_true, seed=seed, seed2=seed2, name=name)
ComputeAccidentalHits.__doc__ = compute_accidental_hits.__doc__
ComputeAccidentalHits = _doc_controls.do_not_generate_docs(_kwarg_only(ComputeAccidentalHits))
...
def FixedUnigramCandidateSampler(true_classes, num_true, num_sampled, unique, range_max, vocab_file="", distortion=1, num_reserved_ids=0, num_shards=1, shard=0, unigrams=[], seed=0, seed2=0, name=None):
  return fixed_unigram_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, range_max=range_max, vocab_file=vocab_file, distortion=distortion, num_reserved_ids=num_reserved_ids, num_shards=num_shards, shard=shard, unigrams=unigrams, seed=seed, seed2=seed2, name=name)
FixedUnigramCandidateSampler.__doc__ = fixed_unigram_candidate_sampler.__doc__
FixedUnigramCandidateSampler = _doc_controls.do_not_generate_docs(_kwarg_only(FixedUnigramCandidateSampler))
...
def LearnedUnigramCandidateSampler(true_classes, num_true, num_sampled, unique, range_max, seed=0, seed2=0, name=None):
  return learned_unigram_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, range_max=range_max, seed=seed, seed2=seed2, name=name)
LearnedUnigramCandidateSampler.__doc__ = learned_unigram_candidate_sampler.__doc__
LearnedUnigramCandidateSampler = _doc_controls.do_not_generate_docs(_kwarg_only(LearnedUnigramCandidateSampler))
...
def LogUniformCandidateSampler(true_classes, num_true, num_sampled, unique, range_max, seed=0, seed2=0, name=None):
  return log_uniform_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, range_max=range_max, seed=seed, seed2=seed2, name=name)
LogUniformCandidateSampler.__doc__ = log_uniform_candidate_sampler.__doc__
LogUniformCandidateSampler = _doc_controls.do_not_generate_docs(_kwarg_only(LogUniformCandidateSampler))
...
def ThreadUnsafeUnigramCandidateSampler(true_classes, num_true, num_sampled, unique, range_max, seed=0, seed2=0, name=None):
  return thread_unsafe_unigram_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, range_max=range_max, seed=seed, seed2=seed2, name=name)
ThreadUnsafeUnigramCandidateSampler.__doc__ = thread_unsafe_unigram_candidate_sampler.__doc__
ThreadUnsafeUnigramCandidateSampler = _doc_controls.do_not_generate_docs(_kwarg_only(ThreadUnsafeUnigramCandidateSampler))
...
def UniformCandidateSampler(true_classes, num_true, num_sampled, unique, range_max, seed=0, seed2=0, name=None):
  return uniform_candidate_sampler(true_classes=true_classes, num_true=num_true, num_sampled=num_sampled, unique=unique, range_max=range_max, seed=seed, seed2=seed2, name=name)
UniformCandidateSampler.__doc__ = uniform_candidate_sampler.__doc__
UniformCandidateSampler = _doc_controls.do_not_generate_docs(_kwarg_only(UniformCandidateSampler))
