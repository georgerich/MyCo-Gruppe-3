...
def AddManySparseToTensorsMap(sparse_indices, sparse_values, sparse_shape, container="", shared_name="", name=None):
  return add_many_sparse_to_tensors_map(sparse_indices=sparse_indices, sparse_values=sparse_values, sparse_shape=sparse_shape, container=container, shared_name=shared_name, name=name)
AddManySparseToTensorsMap.__doc__ = add_many_sparse_to_tensors_map.__doc__
AddManySparseToTensorsMap = _doc_controls.do_not_generate_docs(_kwarg_only(AddManySparseToTensorsMap))
...
def AddSparseToTensorsMap(sparse_indices, sparse_values, sparse_shape, container="", shared_name="", name=None):
  return add_sparse_to_tensors_map(sparse_indices=sparse_indices, sparse_values=sparse_values, sparse_shape=sparse_shape, container=container, shared_name=shared_name, name=name)
AddSparseToTensorsMap.__doc__ = add_sparse_to_tensors_map.__doc__
AddSparseToTensorsMap = _doc_controls.do_not_generate_docs(_kwarg_only(AddSparseToTensorsMap))
...
def DeserializeManySparse(serialized_sparse, dtype, name=None):
  return deserialize_many_sparse(serialized_sparse=serialized_sparse, dtype=dtype, name=name)
DeserializeManySparse.__doc__ = deserialize_many_sparse.__doc__
DeserializeManySparse = _doc_controls.do_not_generate_docs(_kwarg_only(DeserializeManySparse))
...
def DeserializeSparse(serialized_sparse, dtype, name=None):
  return deserialize_sparse(serialized_sparse=serialized_sparse, dtype=dtype, name=name)
DeserializeSparse.__doc__ = deserialize_sparse.__doc__
DeserializeSparse = _doc_controls.do_not_generate_docs(_kwarg_only(DeserializeSparse))
...
def SerializeManySparse(sparse_indices, sparse_values, sparse_shape, out_type=_dtypes.string, name=None):
  return serialize_many_sparse(sparse_indices=sparse_indices, sparse_values=sparse_values, sparse_shape=sparse_shape, out_type=out_type, name=name)
SerializeManySparse.__doc__ = serialize_many_sparse.__doc__
SerializeManySparse = _doc_controls.do_not_generate_docs(_kwarg_only(SerializeManySparse))
...
def SerializeSparse(sparse_indices, sparse_values, sparse_shape, out_type=_dtypes.string, name=None):
  return serialize_sparse(sparse_indices=sparse_indices, sparse_values=sparse_values, sparse_shape=sparse_shape, out_type=out_type, name=name)
SerializeSparse.__doc__ = serialize_sparse.__doc__
SerializeSparse = _doc_controls.do_not_generate_docs(_kwarg_only(SerializeSparse))
...
def SparseAdd(a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh, name=None):
  return sparse_add(a_indices=a_indices, a_values=a_values, a_shape=a_shape, b_indices=b_indices, b_values=b_values, b_shape=b_shape, thresh=thresh, name=name)
SparseAdd.__doc__ = sparse_add.__doc__
SparseAdd = _doc_controls.do_not_generate_docs(_kwarg_only(SparseAdd))
...
def SparseAddGrad(backprop_val_grad, a_indices, b_indices, sum_indices, name=None):
  return sparse_add_grad(backprop_val_grad=backprop_val_grad, a_indices=a_indices, b_indices=b_indices, sum_indices=sum_indices, name=name)
SparseAddGrad.__doc__ = sparse_add_grad.__doc__
SparseAddGrad = _doc_controls.do_not_generate_docs(_kwarg_only(SparseAddGrad))
...
def SparseConcat(indices, values, shapes, concat_dim, name=None):
  return sparse_concat(indices=indices, values=values, shapes=shapes, concat_dim=concat_dim, name=name)
SparseConcat.__doc__ = sparse_concat.__doc__
SparseConcat = _doc_controls.do_not_generate_docs(_kwarg_only(SparseConcat))
...
def SparseCross(indices, values, shapes, dense_inputs, hashed_output, num_buckets, hash_key, out_type, internal_type, name=None):
  return sparse_cross(indices=indices, values=values, shapes=shapes, dense_inputs=dense_inputs, hashed_output=hashed_output, num_buckets=num_buckets, hash_key=hash_key, out_type=out_type, internal_type=internal_type, name=name)
SparseCross.__doc__ = sparse_cross.__doc__
SparseCross = _doc_controls.do_not_generate_docs(_kwarg_only(SparseCross))
...
def SparseDenseCwiseAdd(sp_indices, sp_values, sp_shape, dense, name=None):
  return sparse_dense_cwise_add(sp_indices=sp_indices, sp_values=sp_values, sp_shape=sp_shape, dense=dense, name=name)
SparseDenseCwiseAdd.__doc__ = sparse_dense_cwise_add.__doc__
SparseDenseCwiseAdd = _doc_controls.do_not_generate_docs(_kwarg_only(SparseDenseCwiseAdd))
...
def SparseDenseCwiseDiv(sp_indices, sp_values, sp_shape, dense, name=None):
  return sparse_dense_cwise_div(sp_indices=sp_indices, sp_values=sp_values, sp_shape=sp_shape, dense=dense, name=name)
SparseDenseCwiseDiv.__doc__ = sparse_dense_cwise_div.__doc__
SparseDenseCwiseDiv = _doc_controls.do_not_generate_docs(_kwarg_only(SparseDenseCwiseDiv))
...
def SparseDenseCwiseMul(sp_indices, sp_values, sp_shape, dense, name=None):
  return sparse_dense_cwise_mul(sp_indices=sp_indices, sp_values=sp_values, sp_shape=sp_shape, dense=dense, name=name)
SparseDenseCwiseMul.__doc__ = sparse_dense_cwise_mul.__doc__
SparseDenseCwiseMul = _doc_controls.do_not_generate_docs(_kwarg_only(SparseDenseCwiseMul))
...
def SparseFillEmptyRows(indices, values, dense_shape, default_value, name=None):
  return sparse_fill_empty_rows(indices=indices, values=values, dense_shape=dense_shape, default_value=default_value, name=name)
SparseFillEmptyRows.__doc__ = sparse_fill_empty_rows.__doc__
SparseFillEmptyRows = _doc_controls.do_not_generate_docs(_kwarg_only(SparseFillEmptyRows))
...
def SparseFillEmptyRowsGrad(reverse_index_map, grad_values, name=None):
  return sparse_fill_empty_rows_grad(reverse_index_map=reverse_index_map, grad_values=grad_values, name=name)
SparseFillEmptyRowsGrad.__doc__ = sparse_fill_empty_rows_grad.__doc__
SparseFillEmptyRowsGrad = _doc_controls.do_not_generate_docs(_kwarg_only(SparseFillEmptyRowsGrad))
...
def SparseReduceMax(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  return sparse_reduce_max(input_indices=input_indices, input_values=input_values, input_shape=input_shape, reduction_axes=reduction_axes, keep_dims=keep_dims, name=name)
SparseReduceMax.__doc__ = sparse_reduce_max.__doc__
SparseReduceMax = _doc_controls.do_not_generate_docs(_kwarg_only(SparseReduceMax))
...
def SparseReduceMaxSparse(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  return sparse_reduce_max_sparse(input_indices=input_indices, input_values=input_values, input_shape=input_shape, reduction_axes=reduction_axes, keep_dims=keep_dims, name=name)
SparseReduceMaxSparse.__doc__ = sparse_reduce_max_sparse.__doc__
SparseReduceMaxSparse = _doc_controls.do_not_generate_docs(_kwarg_only(SparseReduceMaxSparse))
...
def SparseReduceSum(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  return sparse_reduce_sum(input_indices=input_indices, input_values=input_values, input_shape=input_shape, reduction_axes=reduction_axes, keep_dims=keep_dims, name=name)
SparseReduceSum.__doc__ = sparse_reduce_sum.__doc__
SparseReduceSum = _doc_controls.do_not_generate_docs(_kwarg_only(SparseReduceSum))
...
def SparseReduceSumSparse(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  return sparse_reduce_sum_sparse(input_indices=input_indices, input_values=input_values, input_shape=input_shape, reduction_axes=reduction_axes, keep_dims=keep_dims, name=name)
SparseReduceSumSparse.__doc__ = sparse_reduce_sum_sparse.__doc__
SparseReduceSumSparse = _doc_controls.do_not_generate_docs(_kwarg_only(SparseReduceSumSparse))
...
def SparseReorder(input_indices, input_values, input_shape, name=None):
  return sparse_reorder(input_indices=input_indices, input_values=input_values, input_shape=input_shape, name=name)
SparseReorder.__doc__ = sparse_reorder.__doc__
SparseReorder = _doc_controls.do_not_generate_docs(_kwarg_only(SparseReorder))
...
def SparseReshape(input_indices, input_shape, new_shape, name=None):
  return sparse_reshape(input_indices=input_indices, input_shape=input_shape, new_shape=new_shape, name=name)
SparseReshape.__doc__ = sparse_reshape.__doc__
SparseReshape = _doc_controls.do_not_generate_docs(_kwarg_only(SparseReshape))
...
def SparseSlice(indices, values, shape, start, size, name=None):
  return sparse_slice(indices=indices, values=values, shape=shape, start=start, size=size, name=name)
SparseSlice.__doc__ = sparse_slice.__doc__
SparseSlice = _doc_controls.do_not_generate_docs(_kwarg_only(SparseSlice))
...
def SparseSliceGrad(backprop_val_grad, input_indices, input_start, output_indices, name=None):
  return sparse_slice_grad(backprop_val_grad=backprop_val_grad, input_indices=input_indices, input_start=input_start, output_indices=output_indices, name=name)
SparseSliceGrad.__doc__ = sparse_slice_grad.__doc__
SparseSliceGrad = _doc_controls.do_not_generate_docs(_kwarg_only(SparseSliceGrad))
...
def SparseSoftmax(sp_indices, sp_values, sp_shape, name=None):
  return sparse_softmax(sp_indices=sp_indices, sp_values=sp_values, sp_shape=sp_shape, name=name)
SparseSoftmax.__doc__ = sparse_softmax.__doc__
SparseSoftmax = _doc_controls.do_not_generate_docs(_kwarg_only(SparseSoftmax))
...
def SparseSparseMaximum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name=None):
  return sparse_sparse_maximum(a_indices=a_indices, a_values=a_values, a_shape=a_shape, b_indices=b_indices, b_values=b_values, b_shape=b_shape, name=name)
SparseSparseMaximum.__doc__ = sparse_sparse_maximum.__doc__
SparseSparseMaximum = _doc_controls.do_not_generate_docs(_kwarg_only(SparseSparseMaximum))
...
def SparseSparseMinimum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name=None):
  return sparse_sparse_minimum(a_indices=a_indices, a_values=a_values, a_shape=a_shape, b_indices=b_indices, b_values=b_values, b_shape=b_shape, name=name)
SparseSparseMinimum.__doc__ = sparse_sparse_minimum.__doc__
SparseSparseMinimum = _doc_controls.do_not_generate_docs(_kwarg_only(SparseSparseMinimum))
...
def SparseSplit(split_dim, indices, values, shape, num_split, name=None):
  return sparse_split(split_dim=split_dim, indices=indices, values=values, shape=shape, num_split=num_split, name=name)
SparseSplit.__doc__ = sparse_split.__doc__
SparseSplit = _doc_controls.do_not_generate_docs(_kwarg_only(SparseSplit))
...
def SparseTensorDenseAdd(a_indices, a_values, a_shape, b, name=None):
  return sparse_tensor_dense_add(a_indices=a_indices, a_values=a_values, a_shape=a_shape, b=b, name=name)
SparseTensorDenseAdd.__doc__ = sparse_tensor_dense_add.__doc__
SparseTensorDenseAdd = _doc_controls.do_not_generate_docs(_kwarg_only(SparseTensorDenseAdd))
...
def SparseTensorDenseMatMul(a_indices, a_values, a_shape, b, adjoint_a=False, adjoint_b=False, name=None):
  return sparse_tensor_dense_mat_mul(a_indices=a_indices, a_values=a_values, a_shape=a_shape, b=b, adjoint_a=adjoint_a, adjoint_b=adjoint_b, name=name)
SparseTensorDenseMatMul.__doc__ = sparse_tensor_dense_mat_mul.__doc__
SparseTensorDenseMatMul = _doc_controls.do_not_generate_docs(_kwarg_only(SparseTensorDenseMatMul))
...
def SparseToDense(sparse_indices, output_shape, sparse_values, default_value, validate_indices=True, name=None):
  return sparse_to_dense(sparse_indices=sparse_indices, output_shape=output_shape, sparse_values=sparse_values, default_value=default_value, validate_indices=validate_indices, name=name)
SparseToDense.__doc__ = sparse_to_dense.__doc__
SparseToDense = _doc_controls.do_not_generate_docs(_kwarg_only(SparseToDense))
...
def TakeManySparseFromTensorsMap(sparse_handles, dtype, container="", shared_name="", name=None):
  return take_many_sparse_from_tensors_map(sparse_handles=sparse_handles, dtype=dtype, container=container, shared_name=shared_name, name=name)
TakeManySparseFromTensorsMap.__doc__ = take_many_sparse_from_tensors_map.__doc__
TakeManySparseFromTensorsMap = _doc_controls.do_not_generate_docs(_kwarg_only(TakeManySparseFromTensorsMap))
