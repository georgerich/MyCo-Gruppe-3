...
def anonymous_iterator_v2(output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "AnonymousIteratorV2", name, _ctx._post_execution_callbacks,
        "output_types", output_types, "output_shapes", output_shapes)
...
def anonymous_memory_cache(name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "AnonymousMemoryCache", name, _ctx._post_execution_callbacks)
...
def anonymous_multi_device_iterator(devices, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "AnonymousMultiDeviceIterator", name, _ctx._post_execution_callbacks,
...
def anonymous_random_seed_generator(seed, seed2, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "AnonymousRandomSeedGenerator", name, _ctx._post_execution_callbacks,
        seed, seed2)
...
def cache_dataset_v2(input_dataset, filename, cache, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "CacheDatasetV2", name, _ctx._post_execution_callbacks, input_dataset,
...
def DatasetToGraph(input_dataset, name=None):
  return dataset_to_graph(input_dataset=input_dataset, name=name)
...
def delete_iterator(handle, deleter, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DeleteIterator", name, _ctx._post_execution_callbacks, handle,
        deleter)
      return _result
    except _core._FallbackException:
      try:
...
def delete_memory_cache(handle, deleter, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DeleteMemoryCache", name, _ctx._post_execution_callbacks, handle,
        deleter)
      return _result
    except _core._FallbackException:
      try:
...
def delete_multi_device_iterator(multi_device_iterator, iterators, deleter, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DeleteMultiDeviceIterator", name, _ctx._post_execution_callbacks,
...
def delete_random_seed_generator(handle, deleter, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DeleteRandomSeedGenerator", name, _ctx._post_execution_callbacks,
        handle, deleter)
      return _result
    except _core._FallbackException:
      try:
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "output_shapes", output_shapes, "optimization_configs",
...
def prefetch_dataset(input_dataset, buffer_size, output_types, output_shapes, slack_period=0, name=None):
    ...
    try:
      ...
      try:
        return prefetch_dataset_eager_fallback(
            input_dataset, buffer_size, output_types=output_types,
            output_shapes=output_shapes, slack_period=slack_period, name=name,
            ctx=_ctx)
      except _core._SymbolicException:
        pass  # Add nodes to the TensorFlow graph.
    except _core._NotOkStatusException as e:
  ...
  _attrs = ("output_types", _op.get_attr("output_types"), "output_shapes",
            ...
            _op.get_attr("slack_period"))
  _execute.record_gradient(
      "PrefetchDataset", _inputs_flat, _attrs, _result, name)
  _result, = _result
  return _result

def PrefetchDataset(input_dataset, buffer_size, output_types, output_shapes, slack_period=0, name=None):
  return prefetch_dataset(input_dataset=input_dataset, buffer_size=buffer_size, output_types=output_types, output_shapes=output_shapes, slack_period=slack_period, name=name)
...
def prefetch_dataset_eager_fallback(input_dataset, buffer_size, output_types, output_shapes, slack_period=0, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def shuffle_dataset_v2(input_dataset, buffer_size, seed_generator, output_types, output_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ShuffleDatasetV2", name, _ctx._post_execution_callbacks,
