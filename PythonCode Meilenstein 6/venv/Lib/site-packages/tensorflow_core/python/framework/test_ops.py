...
def n_polymorphic_out(T, N, name=None):
  ...
  _result = _op.outputs[:]
  _inputs_flat = _op.inputs
  _attrs = ("T", _op._get_attr_type("T"), "N", _op.get_attr("N"))
  _execute.record_gradient(
...
_namespace_test_string_output_outputs = ["output1", "output2"]
_Namespace_TestStringOutputOutput = _collections.namedtuple(
    "Namespace_TestStringOutput", _namespace_test_string_output_outputs)
...
def namespace_test_string_output(input, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "Namespace>TestStringOutput", name, _ctx._post_execution_callbacks,
        input)
  ...
  _attrs = None
  _execute.record_gradient(
      "Namespace>TestStringOutput", _inputs_flat, _attrs, _result, name)
  _result = _Namespace_TestStringOutputOutput._make(_result)
  return _result

def Namespace_TestStringOutput(input, name=None):
  return namespace_test_string_output(input=input, name=name)
Namespace_TestStringOutput.__doc__ = namespace_test_string_output.__doc__
Namespace_TestStringOutput = _doc_controls.do_not_generate_docs(_kwarg_only(Namespace_TestStringOutput))
tf_export("raw_ops.Namespace_TestStringOutput")(Namespace_TestStringOutput)


def namespace_test_string_output_eager_fallback(input, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function namespace_test_string_output
  """
  _ctx = ctx if ctx else _context.context()
...
_ops.RegisterShape("Namespace>TestStringOutput")(None)
...
# }
# op {
#   name: "Namespace>TestStringOutput"
#   input_arg {
#     name: "input"
#     type: DT_FLOAT
#   }
